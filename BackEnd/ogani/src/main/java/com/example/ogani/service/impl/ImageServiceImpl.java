...
public class ImageServiceImpl implements ImageService {
    ...
    @Override
    public boolean linkImageToProduct(long imageId, long productId) {
        try {
            // Logic liên kết ảnh với sản phẩm
            // (Không cần implement đầy đủ ngay lúc này để khắc phục lỗi compile)
            return true;
        } catch (Exception e) {
            return false;
        }
