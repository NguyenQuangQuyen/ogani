...
const BLOG_API = 'https://hgr0a62zxby.sn.mynetname.net:2003/api/blog/';
const httpOptions = {
...
export class BlogService {
  ...
  createBlog(
    ...
    return this.http.post(
      BLOG_API + 'create',
      { title, description, content, imageId, tags, username },
      httpOptions
    );
  }
  ...
  updateBLog(
    ...
    return this.http.put(
      BLOG_API + 'update/' + id,
      { id, title, description, content, imageId, tags },
      httpOptions
    );
  }
